...
namespace Dune {
  ...
  namespace Impl {
    ...
    struct UniqueTypesHelper<Target, TypeList<T0, T...>, Processed...>
    {
      using type = std::conditional_t<
        ...
        typename UniqueTypesHelper<Target, TypeList<T...>, Processed..., T0>::type>;
    };
   ...
   * with duplicate types. The order of the types in the pack S...
   * corresponds to the order of the types in T... (up to the filtered out
   * duplicate types).
   */
  template<template<class...> class Target, class... T>
